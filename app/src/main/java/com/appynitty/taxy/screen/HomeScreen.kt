...
fun HomeScreen(navController: NavHostController) {
    ...
    Scaffold(
        topBar = { CustomToolbarScreen(navController = navController, title = "Dashboard") }
    ) { innerPadding ->
        Column(
            ...
            Row(
                ...
                Button( onClick = { navController.navigate(Routes.Signup.route) }, colors = ButtonDefaults.buttonColors(
                    Color.Gray)) {
                    Text(
                        text = "SignUp",
                        style = TextStyle(fontSize = 14.sp)
